...
const quizzes: {
...
} = await inquirer.prompt([
  {
    ...
    message:
      chalk.bold.greenBright`Q:1 In Typescript, What is the correct syntax to Check a is Greater than b ?`,
  },
  {
    type: "list",
    name: "Question_2",
  ...
  },
  {
    ...
    choices: [":", ".", ";", ","],
    message:
    chalk.bold.greenBright`Q:3 In TypeScript, which symbol is commonly used to terminate a statement ?`,
  },
  {
    type: "list",
    name: "Question_4",
    choices: ["&", "$", "@", "#"],
    message:
    chalk.bold.greenBright`Q:4 In TypeScript, Which of the following characters is commonly allowed in variable names in typescript ?`,
  },
  {
    type: "list",
    name: "Question_5",
    ...
    message:
    chalk.bold.greenBright`Q:5 In TypeScript, Which method of inquirer.js is used to start the prompt interface and recieve user input ?`,
  },
]);
